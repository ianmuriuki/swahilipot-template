    ...
    <section className="py-16 bg-orange-50 dark:bg-gray-800">
      <div className="container-custom mx-auto px-6 md:px-12 lg:px-16 max-w-7xl">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">Meet Our Community Team</h2>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Our dedicated community team works tirelessly to create an inclusive, engaging, and empowering space for all members of Swahilipot Hub.
          </p>
        </div>
