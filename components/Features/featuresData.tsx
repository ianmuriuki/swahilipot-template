...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Designed to provide startups with a strong foundation, offering modern tools and best practices.",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "Beautiful, professional-grade design to ensure user satisfaction and engagement.",
  },
  {
    id: 3,
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        <path
          opacity="0.5"
          d="M20 30C22.75 30 25 32.25 25 35C25 37.75 22.75 40 20 40C17.25 40 15 37.75 15 35C15 32.25 17.25 30 20 30ZM35 30C37.75 30 40 32.25 40 35C40 37.75 37.75 40 35 40C32.25 40 30 37.75 30 35C30 32.25 32.25 30 35 30Z"
        />
      </svg>
    ),
    title: "Next.js 13 (Latest)",
    paragraph:
      "Built with the latest Next.js 13 for improved performance and developer experience.",
  },
];
