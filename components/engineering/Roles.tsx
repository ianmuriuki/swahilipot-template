      ...
      <section className="py-16 bg-light dark:bg-gray-900">
        <div className="container-custom mx-auto px-6 md:px-12 lg:px-16 max-w-7xl">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold mb-4">The Engineering Department Roles</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Explore the various roles within our Engineering Department and the skills required for each position.
            </p>
          </div>
